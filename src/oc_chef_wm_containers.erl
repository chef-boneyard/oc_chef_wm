...
validate_request('POST', Req, #base_state{resource_state = ContainerState}= State) ->
    ...
    {ok, Json} = oc_chef_container:parse_binary_json(Body),
    {Req, State#base_state{resource_state = ContainerState#container_state{container_data = Json}}}. 
